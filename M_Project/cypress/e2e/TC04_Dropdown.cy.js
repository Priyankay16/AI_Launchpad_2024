...
describe('Dropdown Functionality',function(){
    ...
    it('Handling Multiple Dropdpwn',function(){
        ...
        cy.get('div[class="mbsc-scroller-wheel-item mbsc-ios mbsc-ltr mbsc-wheel-item-checkmark mbsc-wheel-item-multi"]').contains('Home, Garden & Tools').click()
        cy.get('div[class="mbsc-scroller-wheel-item mbsc-ios mbsc-ltr mbsc-wheel-item-checkmark mbsc-wheel-item-multi"]').contains('Toys, Kids & Baby').click()
    })
})